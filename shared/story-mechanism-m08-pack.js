...
const M08_7 = pack(
  ...
  [
    variant({"id":"V01","title":"希望任务成功","description":"阵营收益绑定公共成功。","beatPattern":{"setup":"阵营关系进入可观察状态","develop":"压力与信息差推动成员选择","resolve":"归属或目标变化产生剧情后果"},"requiredSlots":["factionLead","memberA"],"preferredSlots":["memberB","outsider"],"incompatibilities":[],"recommendedCluePattern":["FACTION_FORESHADOW","MEMBERSHIP_HINT","FACTION_EXPOSURE"],"revealPattern":"staged_exposure","consequencePattern":"allegiance_shift","membershipPattern":"PRIVATE","informationPattern":"MEMBERS_MUTUAL","pressurePattern":"loyalty_test","defaults":{"publicGoal":"维护秩序","factionGoal":"夺取关键资源"},"semanticOverrides":{"phases":{"progression":{"goal":"确保公共任务成功","action":"组织成员推动任务完成","target":"公共任务状态","actionKind":"SUPPORT_PUBLIC_TASK","produces":[{"id":"public_task_success_pressure","factType":"public_task_success_pressure","kind":"public_task_success_pressure","summary":"公共任务成功压力"}]}}},"semanticExpectations":{"requiredGoalTokens":["成功"],"forbiddenGoalTokens":["失败","延迟","成功、失败或延迟"],"requiredActionKind":"SUPPORT_PUBLIC_TASK","requiredFactTypes":["public_task_success_pressure"]}}),
    variant({"id":"V02","title":"希望任务失败","description":"阵营有正式破坏动作。","beatPattern":{"setup":"阵营关系进入可观察状态","develop":"压力与信息差推动成员选择","resolve":"归属或目标变化产生剧情后果"},"requiredSlots":["factionLead","memberA"],"preferredSlots":["memberB","outsider"],"incompatibilities":[],"recommendedCluePattern":["FACTION_FORESHADOW","MEMBERSHIP_HINT","FACTION_EXPOSURE"],"revealPattern":"staged_exposure","consequencePattern":"allegiance_shift","membershipPattern":"PRIVATE","informationPattern":"MEMBERS_MUTUAL","pressurePattern":"loyalty_test","defaults":{"betrayalTrigger":"利益冲突","exposureRisk":"行动失败"},"semanticOverrides":{"phases":{"progression":{"goal":"阻止公共任务完成","action":"干扰关键步骤或资源以破坏任务","target":"公共任务状态","actionKind":"SABOTAGE_PUBLIC_TASK","produces":[{"id":"public_task_failure_pressure","factType":"public_task_failure_pressure","kind":"public_task_failure_pressure","summary":"公共任务失败压力"}]}}},"semanticExpectations":{"requiredGoalTokens":["阻止"],"forbiddenGoalTokens":["确保公共任务成功","成功、失败或延迟"],"requiredActionKind":"SABOTAGE_PUBLIC_TASK","requiredFactTypes":["public_task_failure_pressure"]}}),
