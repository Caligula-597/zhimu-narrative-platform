...
const checks = [
  ...
  ["app-tabletop-map-lazy", matchingAsset(surfaces.app, /^tabletop-map-[^/]+\.js$/), 23 * 1024],
  ["app-tabletop-map-css", matchingAsset(surfaces.app, /^tabletop-map-[^/]+\.css$/), 6 * 1024],
  ["app-tabletop-map-board", matchingAsset(surfaces.app, /^tabletop-map-board-[^/]+\.webp$/), 250 * 1024],
  ...
  ["site-entry-css", htmlAsset(surfaces.site, /assets\/[^/]+\.css$/), 10 * 1024],
