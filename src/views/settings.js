...
export function settings(){
 ...
 <article class="card"><div class="section-head"><div><h3>运行态段落</h3><p>Segment 聚合层：段落键、真相链与角色关系（不替换私人分幕）。</p></div><div class="row"><button class="secondary-btn" data-go="structure">Segment 工作台</button><button class="secondary-btn" data-go="truth">真相与关系</button></div></div></article>
