...
export function settings(){
 ...
 <article class="card"><div class="section-head"><div><h3>运行态段落</h3><p>Segment 聚合层：段落键、真相链与角色关系（不替换私人分幕）。</p></div><div class="row"><button class="secondary-btn" data-action="open-world-segments">段落</button><button class="secondary-btn" data-action="open-truth-claims">真相链</button><button class="secondary-btn" data-action="open-role-relationships">关系图</button></div></div></article>
