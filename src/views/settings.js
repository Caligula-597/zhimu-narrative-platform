...
function settings(){
 ...
 <aside class="card"><div class="section-head"><div><h3>账号与内容资产</h3><p>登录、配额、云端附件与会话管理</p></div></div><button class="secondary-btn full-btn" data-action="open-account-hub">打开账号与资产</button><button class="secondary-btn full-btn" style="margin-top:10px" data-action="open-account-hub" data-hub-tab="assets">管理云端附件</button></aside>
