...
function recapListSection(recaps,isPlayer){
 ...
 if(!recaps.length)return `<div class="empty-state">尚未生成复盘。跑团结束后点击「生成复盘」，系统会从 timeline_logs、clue_ownership 与规则执行记录汇总。</div>`;
