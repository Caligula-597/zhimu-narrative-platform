...
function openCreatorSection(roleId,sectionId=""){
 ...
 modal.className="modal manuscript-editor-modal";modal.innerHTML=`<h2 class="editor-modal-title">${section?"编辑角色分幕":"新增角色分幕"}</h2>${manuscriptEditorHtml(data,role,section)}`;
