...
function assetsPanelHtml(){
  ...
  }).join(""):`<div class="empty-state enriched-empty">${recycle?"回收站为空。":q||kind?"没有匹配的附件。":"<p><strong>当前世界还没有上传附件</strong></p><p>附件会存储在 Cloudflare R2，可在剧情编排中关联到场景或线索。公开示例剧本（如雾港来信）通常已有丰富附件可供参考。</p><ul class=\"empty-hints\"><li>支持图片、音频、PDF 等格式</li><li>上传后在编排台节点面板中关联</li><li>删除后进入 14 天回收站，可恢复</li></ul><div class=\"row\"><button class=\"primary-btn\" data-action=\"upload-asset\">↑ 上传首个附件</button><button class=\"secondary-btn\" data-action=\"open-creator-guide\">查看上传说明</button><button class=\"text-btn\" data-action=\"open-catalog\">浏览公开示例</button></div>"}</div>`;
