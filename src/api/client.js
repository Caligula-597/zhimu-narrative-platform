...
window.zhimuApi = {
  ...
  deepseekPipelineNarrativeRoleScript: (payload) => deepseekRequest(`/worlds/${demoContext.worldId}/story-assistant/deepseek/pipeline/narrative/role-script`, { userId: demoContext.hostUserId, method: "POST", body: payload }),
