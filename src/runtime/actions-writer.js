...
(function (window) {
  function handleWriterAction(action, el) {
    switch (action) {
      ...
      case "opening-package-stage-confirm": callView("writer", "confirmOpeningPackageStageSchema"); return true;
      case "opening-package-stage-reject": callView("writer", "rejectOpeningPackageStageSchema"); return true;
      case "opening-package-stage-manual": callView("writer", "editOpeningPackageStageSchema"); return true;
      case "opening-package-stage-manual-save": callView("writer", "saveOpeningPackageStageSchemaManual"); return true;
      case "opening-package-stage-manual-cancel": callView("writer", "cancelOpeningPackageStageSchemaManual"); return true;
      case "world-engine": callView("writer", "openWorldEngine"); return true;
      case "misidentification": callView("writer", "openMisidentification"); return true;
      case "relationship-arc": callView("writer", "openRelationshipArc"); return true;
      case "knowledge-matrix": callView("writer", "openKnowledgeMatrix"); return true;
      case "ending-branch": callView("writer", "openEnding"); return true;
      case "host-manual-compiler": callView("writer", "openHostManualCompiler"); return true;
      case "object-lifecycle": callView("writer", "openObjectLifecycle"); return true;
      case "timeline": callView("writer", "openTimeline"); return true;
      case "history-causal": callView("writer", "openHistoryCausal"); return true;
      case "runtime-machine": callView("writer", "openRuntimeStateMachine"); return true;
      case "val-consistency": callView("writer", "openValConsistency"); return true;
      case "econ-system": callView("writer", "openEconSystem"); return true;
      case "npc-script": callView("writer", "openNpcScript"); return true;
      case "location-state": callView("writer", "openLocationState"); return true;
