...
(function (window) {
  function handleWriterAction(action, el) {
    switch (action) {
      ...
      case "opening-package": callView("writer", "openOpeningPackage"); return true;
      case "opening-package-next": callView("writer", "nextOpeningPackageStep"); return true;
      case "opening-package-back": callView("writer", "backOpeningPackageStep"); return true;
      case "opening-package-skip": callView("writer", "skipOpeningPackageStep"); return true;
      case "opening-package-preview-run": callView("writer", "previewOpeningPackageWorkspace"); return true;
      case "opening-package-commit": callView("writer", "commitOpeningPackageWorkspace"); return true;
