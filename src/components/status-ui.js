...
(function (window) {
  ...
  function normalizeError(error, fallback = "操作失败，请稍后重试。") {
    ...
    return window.zhimuUserMessages?.friendlyApiError?.(payload, error.message || fallback) || error.message || fallback;
  }
