...
## 2026-06-18 · 主持—玩家联动与文档收口

| 领域 | 交付 |
|------|------|
| 后端 | `player-home.hostConfirm` · `POST host/nudge-waiting` · 测试 hooks 禁用 IP 注册上限 |
| 主应用 | 主持台 wait strip / nudge · 玩家复盘模态 · `host-audit-card` |
| play | 复盘 Tab · URL 路由 · SSE `patch-game` 局部刷新 · 账号找回/验证 |
| 文档 | [docs/DESIGN_ZH.md](./docs/DESIGN_ZH.md) · 全库验收数字统一 **341/61/44/51/7** |
| 验收 | backend **341** · schema **61** · smoke **18** · UI **44** · E2E **7** · `verify:full:fresh` |
...
| 验收 | backend **323** 测试 · schema **56** · smoke **18** · `verify:full:fresh`（**当时**；当前见 [SECURITY_AND_TESTING.md](./SECURITY_AND_TESTING.md)） |
