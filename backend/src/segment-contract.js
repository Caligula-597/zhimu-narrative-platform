/**
 * Backend Segment contract.
 *
 * Keep this aligned with shared/segment-contract.js. Backend src modules do not
 * import outside backend/src so verify-modules can keep the module graph tight.
 */
