/**
 * Infer which scene owns child nodes (investigation points, clues, items).
 * Shared by auto-layout and canvas collapse visibility.
 */

/** @param {{ investigationPoints?: object[], edges?: object[] }} snapshot */
export function buildStudioSceneOwnership(snapshot) {
...
export function sortSceneChildNodes(children = []) {
