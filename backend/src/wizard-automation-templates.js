...
export function buildWizardAutomationRules({ roles = [], templates = {} }) {
      ...
      actions: [
        {
          type: "timeline_log",
          message:
            "模板占位：请在「自动化规则」中将条件改为「拥有线索」，动作为「开放场景」，并关联编排台中的线索与场景。"
        }
      ]
    });
  }
...
export function countEnabledTemplates(templates = {}) {
