...
export const API_ERRORS = {
  ...
  EMAIL_VERIFICATION_CODE_INVALID: { status: 400, message: "Email verification code is invalid or expired" },
  EMAIL_VERIFICATION_CODE_ATTEMPTS_EXCEEDED: { status: 429, message: "Too many incorrect verification attempts; request a new code" },
  EMAIL_VERIFICATION_RESEND_COOLDOWN: { status: 429, message: "Please wait before requesting another verification code" },
  ...
  PORTAL_PROFILE_NAME_COOLDOWN: { status: 409, message: "该端昵称每 30 天只能修改一次" },
  ...
  WORLD_PRODUCT_MISMATCH: { status: 409, message: "当前接口不属于该项目类型" },
  WORLD_PRODUCT_IMMUTABLE: { status: 409, message: "项目类型创建后不可更改" },
  ...
  MECHANISM_PACKAGE_NOT_FOUND: { status: 409, message: "当前剧本尚未生成可执行机制运行包" },
  MECHANISM_RUNTIME_NOT_INITIALIZED: { status: 409, message: "当前房间尚未初始化机制运行状态" },
  MECHANISM_RUNTIME_CONTENT_MISMATCH: { status: 409, message: "房间机制状态与当前内容版本不一致，请重置或新建房间" },
  MECHANISM_RUNTIME_REVISION_CONFLICT: { status: 409, message: "机制状态已被其他主持操作更新，请刷新后重试" },
  MECHANISM_RUNTIME_RESET_REQUIRED: { status: 409, message: "已有机制状态；切换内容后必须明确确认重置" },
  ...
  PLAYABLE_RUNTIME_MISSING: { status: 404, message: "当前房间尚未绑定剧本内容运行态" },
  PLAYABLE_RUNTIME_ERROR: { status: 400, message: "剧本内容运行操作失败" },
  PLAYABLE_NOT_READY: { status: 409, message: "PlayableProject 未 READY，无法开局" },
  ALREADY_RUNNING: { status: 409, message: "剧本内容运行态已在进行中" },
  ALREADY_STARTED: { status: 409, message: "剧本会话已开始" },
  RUNTIME_FINISHED: { status: 409, message: "剧本会话已结束" },
  NOT_RUNNING: { status: 409, message: "剧本会话未在运行" },
  UNASSIGNED_ROLES: { status: 409, message: "仍有角色未分配，无法开局" },
  ROLE_NOT_ASSIGNED: { status: 403, message: "你尚未被分配剧本角色" },
  ROLE_TAKEN: { status: 409, message: "该剧本角色已被占用" },
  USER_ALREADY_ASSIGNED: { status: 409, message: "该玩家已分配其他剧本角色" },
  HOST_NOT_ASSIGNABLE: { status: 400, message: "主持角色不可作为玩家分配" },
  UNKNOWN_ROLE: { status: 400, message: "未知剧本角色" },
  UNKNOWN_CONTENT: { status: 400, message: "未知内容单元" },
  UNKNOWN_CLUE: { status: 400, message: "未知线索" },
  UNKNOWN_STAGE: { status: 400, message: "未知分幕" },
  WRONG_STAGE: { status: 409, message: "内容或线索不属于当前分幕" },
  NOT_CURRENT_STAGE: { status: 409, message: "操作不属于当前分幕" },
  CONDITION_LOCKED: { status: 409, message: "条件解锁内容在本阶段不可发放" },
  ALREADY_FINAL: { status: 409, message: "已在终幕，请结束本局" },
  ALREADY_SETTLED: { status: 409, message: "该玩法已结算" },
  INVALID_TRANSITION: { status: 409, message: "非法的玩法状态转换" },
  NOT_ALLOWED: { status: 403, message: "当前不允许该操作" },
  CONTENT_FORBIDDEN: { status: 403, message: "无权查看该内容" },
  CLUE_FORBIDDEN: { status: 403, message: "无权查看该线索" },
  CONTENT_NOT_FOUND: { status: 404, message: "内容不存在" },
  CLUE_NOT_FOUND: { status: 404, message: "线索不存在" },
  CONTENT_NOT_VISIBLE: { status: 403, message: "内容当前不可见，无法标记已读" },
  UNKNOWN_ACTION: { status: 400, message: "未知操作" },
  UNKNOWN_PLACEMENT: { status: 400, message: "未知玩法位置" },
  MECHANISM_NOT_IMPLEMENTED: { status: 409, message: "该玩法本阶段不可运行" },
  MECHANISM_UNSUPPORTED: { status: 400, message: "暂不支持该玩法模板桥接" },
  MECHANISM_ALREADY_SETTLED: { status: 409, message: "该玩法已结算" },
  MECHANISM_NOT_RUNNING: { status: 409, message: "玩法未在运行中" },
  MECHANISM_NOT_STARTED: { status: 409, message: "玩法尚未开始" },
  MECHANISM_NO_WINNER: { status: 409, message: "竞价未产生赢家，无法结算剧本效果" },
  OUTCOME_BINDING_MISSING: { status: 422, message: "玩法缺少可用的 OutcomeBinding" },
  ROLE_REQUIRED: { status: 400, message: "缺少剧本角色" },
  ...
  CLUE_PATH_INVALID: { status: 400, message: "Clue discovery path is invalid" },
  CLUE_SEGMENT_NOT_FOUND: { status: 404, message: "Clue segment not found in world" },
  DISCOVERY_ACTION_INVALID: { status: 409, message: "Discovery action is invalid for the current phase" },
  DISCOVERY_LOCATION_UNAVAILABLE: { status: 404, message: "Discovery location is not available to this player" },
  DISCOVERY_REVISION_REQUIRED: { status: 400, message: "A discovery state revision is required" },
  DISCOVERY_VERSION_CONFLICT: { status: 409, message: "Discovery state changed; refresh before retrying" },
  PACE_CLOCK_ACTION_INVALID: { status: 409, message: "Pace clock action is invalid for the current state" },
  PACE_CLOCK_REVISION_REQUIRED: { status: 400, message: "A pace clock revision is required" },
  PACE_CLOCK_VERSION_CONFLICT: { status: 409, message: "Pace clock changed; refresh before retrying" },
  CONCLUSION_ENDING_INVALID: { status: 409, message: "Ending is not currently eligible for publication" },
  CONCLUSION_ALREADY_PREPARED: { status: 409, message: "A different ending has already prepared this room recap" },
  ...
  CLUE_TRANSFER_TARGET_OWNS: { status: 409, message: "Target player already owns this clue" },
  ...
  ITEM_NOT_OWNED: { status: 404, message: "Item is not present in this role inventory" },
  ITEM_ACTION_CONTRACT_INVALID: { status: 400, message: "Item action contract is invalid" },
  ITEM_ACTION_NOT_ALLOWED: { status: 409, message: "This item does not allow the requested action" },
  ITEM_ACTION_TARGET_INVALID: { status: 409, message: "Item action target is invalid" },
  ...
  CHECKPOINT_MECHANISM_CROSS_ROOM_UNSUPPORTED: { status: 409, message: "Mechanism runtime can only be restored to its original room" },
  ...
  WORLD_ENGINE_CANDIDATE_NOT_FOUND: { status: 404, message: "候选事件已失效，请重新搜索" },
  WORLD_ENGINE_SCRIPT_NOT_FOUND: { status: 404, message: "尚未生成该角色正文" },
