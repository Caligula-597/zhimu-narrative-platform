...
const REQUIRED_SCHEMA_MARKERS = [
  ...
  ["host-content-action-routes.js", 'app.post("/api/rooms/:roomId/host/grant-booklet", { schema:'],
  ["host-content-action-routes.js", 'app.get("/api/rooms/:roomId/host/material-booklets", { schema:'],
